...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.carlito.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Carlito", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Carlito gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Carlito.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "CarlitoShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Carlito is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Carlito Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("carlito-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
