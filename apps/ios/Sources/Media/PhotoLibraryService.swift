...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CarlitoPhotosLatestParams) async throws -> CarlitoPhotosLatestPayload {
        ...
        var results: [CarlitoPhotoPayload] = []
        ...
        return CarlitoPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CarlitoPhotoPayload
    {
