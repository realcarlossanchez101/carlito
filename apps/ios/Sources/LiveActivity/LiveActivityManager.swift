...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.carlito.ios", category: "LiveActivity")
    private var currentActivity: Activity<CarlitoActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = CarlitoActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<CarlitoActivityAttributes>.activities
    ...
    private func updateCurrent(state: CarlitoActivityAttributes.ContentState) {
    ...
    private func connectingState() -> CarlitoActivityAttributes.ContentState {
        CarlitoActivityAttributes.ContentState(
    ...
    private func idleState() -> CarlitoActivityAttributes.ContentState {
        CarlitoActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> CarlitoActivityAttributes.ContentState {
        CarlitoActivityAttributes.ContentState(
