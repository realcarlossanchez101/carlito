...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = CarlitoLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = CarlitoLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.carlito.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Carlito agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Carlito agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Carlito. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(CarlitoLocationMode.off.rawValue)
                            Text("While Using").tag(CarlitoLocationMode.whileUsing.rawValue)
                            Text("Always").tag(CarlitoLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Carlito is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Carlito", value: DeviceInfoHelper.carlitoVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = CarlitoLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Carlito chat and run /pair approve, then tap Connect again."
        }
