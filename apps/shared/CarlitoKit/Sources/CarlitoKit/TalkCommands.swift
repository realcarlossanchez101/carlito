...
public enum CarlitoTalkCommand: String, Codable, Sendable {
...
public struct CarlitoTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct CarlitoTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
