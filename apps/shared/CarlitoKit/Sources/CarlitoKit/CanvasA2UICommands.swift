...
public enum CarlitoCanvasA2UICommand: String, Codable, Sendable {
...
public struct CarlitoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CarlitoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
