...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: CarlitoProtocol.AnyCodable]?
    {
        ...
        return [
            "id": CarlitoProtocol.AnyCodable(identity.deviceId),
            "publicKey": CarlitoProtocol.AnyCodable(publicKey),
            "signature": CarlitoProtocol.AnyCodable(signature),
            "signedAt": CarlitoProtocol.AnyCodable(signedAtMs),
            "nonce": CarlitoProtocol.AnyCodable(nonce),
        ]
    }
}
