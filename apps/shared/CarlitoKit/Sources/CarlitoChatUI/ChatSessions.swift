...
public struct CarlitoChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct CarlitoChatSessionsDefaults: Codable, Sendable {
...
public struct CarlitoChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct CarlitoChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: CarlitoChatSessionsDefaults?
    public let sessions: [CarlitoChatSessionEntry]
    ...
    public init(
        ...
        sessions: [CarlitoChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
