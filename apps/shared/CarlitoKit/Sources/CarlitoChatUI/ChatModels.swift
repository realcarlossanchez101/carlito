...
public typealias CarlitoPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias CarlitoPlatformImage = UIImage
#endif

public struct CarlitoChatUsageCost: Codable, Hashable, Sendable {
...
public struct CarlitoChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: CarlitoChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(CarlitoChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct CarlitoChatMessageContent: Codable, Hashable, Sendable {
...
public struct CarlitoChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [CarlitoChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: CarlitoChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [CarlitoChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: CarlitoChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(CarlitoChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([CarlitoChatMessageContent].self, forKey: .content) {
...
public struct CarlitoChatHistoryPayload: Codable, Sendable {
...
public struct CarlitoSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct CarlitoSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [CarlitoSessionPreviewItem]
}

public struct CarlitoSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [CarlitoSessionPreviewEntry]

    public init(ts: Int, previews: [CarlitoSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct CarlitoChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct CarlitoChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct CarlitoAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct CarlitoChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct CarlitoGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct CarlitoPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: CarlitoPlatformImage?
...
public struct CarlitoChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
