...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "carlito devices approve req-123",
            docsURLString: "https://docs.carlito.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "carlito devices approve req-123")
        #expect(error.docsURLString == "https://docs.carlito.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "carlito devices approve req-123")
    }
