...
import ai.carlito.app.gateway.GatewayClientInfo
import ai.carlito.app.gateway.GatewayConnectOptions
import ai.carlito.app.gateway.GatewayEndpoint
import ai.carlito.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "CarlitoAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "carlito-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "carlito-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
