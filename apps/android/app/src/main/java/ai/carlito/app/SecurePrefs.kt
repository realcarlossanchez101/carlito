...
class SecurePrefs(
  ...
  companion object {
    val defaultWakeWords: List<String> = listOf("carlito", "claude")
    private const val displayNameKey = "node.displayName"
    private const val locationModeKey = "location.enabledMode"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "carlito.node"
    private const val securePrefsName = "carlito.node.secure"
