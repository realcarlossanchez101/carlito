  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("CarlitoWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("CarlitoWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("CarlitoWebView", "onPageFinished: $url")
              }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "carlitoCanvasA2UIAction"
  }
}
