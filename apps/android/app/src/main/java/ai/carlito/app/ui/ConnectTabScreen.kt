    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            Text(
              "Approve this phone on the gateway. Carlito retries automatically while this screen stays open.",
              style = mobileCallout,
              color = mobileTextSecondary,
            )
          ...
          Text("Carlito Android ${carlitoAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("carlito qr --setup-code-only")
          CommandBlock("carlito qr --json")
          Text(
