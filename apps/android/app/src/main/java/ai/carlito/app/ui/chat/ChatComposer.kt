...
import ai.carlito.app.ui.mobileAccentBorderStrong
...
import ai.carlito.app.ui.mobileSurface
import ai.carlito.app.ui.mobileText
import ai.carlito.app.ui.mobileTextSecondary
import ai.carlito.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.carlito.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.carlito.app.ui.mobileFontFamily,
