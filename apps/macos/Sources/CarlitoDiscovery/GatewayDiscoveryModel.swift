...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "ai.carlito", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in CarlitoBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                ...
                domain: domain,
                queueLabelPrefix: "ai.carlito.macos.gateway-discovery",
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = CarlitoBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = CarlitoBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = CarlitoBonjour.wideAreaGatewayServiceDomain else { return false }
