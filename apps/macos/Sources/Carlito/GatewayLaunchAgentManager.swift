...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.carlito", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".carlito/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.carlitoCommand(
            subcommand: "gateway",
