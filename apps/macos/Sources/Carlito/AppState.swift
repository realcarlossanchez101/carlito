...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = CarlitoConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CarlitoConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: CarlitoConfigFile.loadDict(),
            draft: .init(
        ...
        CarlitoConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/carlito"
        state.remoteCliPath = ""
        return state
    }
}
