...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .carlitoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CarlitoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CarlitoPaths.stateDirURL.path
...
extension Notification.Name {
    static let carlitoSelectSettingsTab = Notification.Name("carlitoSelectSettingsTab")
}
