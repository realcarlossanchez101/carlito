...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/realcarlossanchez101/carlito") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/realcarlossanchez101/carlito")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://carlito.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "CarlitoBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CarlitoBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CarlitoGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CarlitoGitCommit") as? String) ??
            "unknown"
    }
