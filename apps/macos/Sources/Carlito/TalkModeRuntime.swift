...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.carlito", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.carlito", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CarlitoChatMessage] = messages.compactMap { item in
