...
enum UIStrings {
    static let welcomeTitle = "Welcome to Carlito"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "carlito.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: CarlitoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g carlito@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: CarlitoChatViewModel(
