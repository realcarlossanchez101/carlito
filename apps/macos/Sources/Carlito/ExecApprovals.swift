...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.carlito", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        CarlitoPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CarlitoPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
