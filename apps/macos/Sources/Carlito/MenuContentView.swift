...
/// Menu contents for the Carlito menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Carlito") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Carlito Not Configured"
        case .remote:
            "Remote Carlito Active"
        case .local:
            "Carlito Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .carlitoSelectSettingsTab, object: tab)
        }
    }
