...
final class TalkMLXSpeechSynthesizer {
    ...
    private let logger = Logger(subsystem: "ai.carlito", category: "talk.mlx")
    ...
    func synthesize(
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("carlito-mlx-tts-\(token.uuidString)", isDirectory: true)
    ...
    private static func helperInvocation() -> HelperInvocation {
        ...
        if let override = ProcessInfo.processInfo.environment["CARLITO_MLX_TTS_BIN"], !override.isEmpty {
        ...
        if let executableDir = Bundle.main.executableURL?.deletingLastPathComponent() {
            let bundled = executableDir.appendingPathComponent("carlito-mlx-tts")
        ...
        return HelperInvocation(
            ...
            argumentPrefix: ["carlito-mlx-tts"],
            displayName: "carlito-mlx-tts")
    }
