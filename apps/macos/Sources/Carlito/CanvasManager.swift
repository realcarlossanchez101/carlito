...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.carlito", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Carlito/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__carlito__/a2ui/").absoluteString + "?platform=macos"
    }
