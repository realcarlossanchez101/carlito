...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.carlito", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Carlito windows, but below the system’s pop-up menus.
