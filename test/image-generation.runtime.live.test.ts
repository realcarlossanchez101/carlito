...
const providerFilter = parseCsvFilter(process.env.CARLITO_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.CARLITO_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.CARLITO_LIVE_IMAGE_GENERATION_MODELS);
