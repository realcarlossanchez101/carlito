...
const WORKER_RUNTIME_STATE = Symbol.for("carlito.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("carlito.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: CarlitoConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
