...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  ...
  const base: PluginRuntime = {
    ...
    system: {
      ...
      requestPulsecheckNow: vi.fn() as unknown as PluginRuntime["system"]["requestPulsecheckNow"],
      runPulsecheckOnce: vi.fn(async () => ({
        status: "ran" as const,
        durationMs: 0,
      })) as unknown as PluginRuntime["system"]["runPulsecheckOnce"],
