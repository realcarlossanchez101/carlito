...
<Steps>
  ...
  <Step title="Configure Carlito">
    Point Carlito at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Carlito
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Carlito integration with Claude CLI or API keys.
  </Card>
