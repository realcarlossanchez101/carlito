...
title: "Together AI"
read_when:
  - You want to use Together AI with Carlito
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    carlito onboard --auth-choice together-api-key
    ```
  </Step>
...
Carlito ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `carlito models list --provider together`
