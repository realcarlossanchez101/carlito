...
Carlito treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.carlito/settings/voicewake.json`

Shape:

```json
{ "triggers": ["carlito", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
