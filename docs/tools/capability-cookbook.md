---
summary: "Contributor guide for adding a new shared capability to the Carlito plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Carlito core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Carlito needs a new domain such as image generation, video
