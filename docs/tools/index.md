---
summary: "Carlito tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Carlito provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Carlito), others are **external** (published on npm by the community).
...
These tools ship with Carlito and are available without installing any plugins:
...
| `group:carlito`    | All built-in Carlito tools (excludes plugin tools)                                                        |
