---
summary: Machine-checked security models for Carlito’s highest-risk paths.
...
This page tracks Carlito’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Carlito enforces its
...
**What this is not (yet):** a proof that “Carlito is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/carlito-formal-models](https://github.com/vignesh07/carlito-formal-models).
...
```bash
git clone https://github.com/vignesh07/carlito-formal-models
cd carlito-formal-models
