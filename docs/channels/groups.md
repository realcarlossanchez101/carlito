...
Carlito treats group chats consistently across surfaces: Discord, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo.

## Beginner intro (2 minutes)

Carlito “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Carlito can see that group and respond there.
...
Translation: allowlisted senders can trigger Carlito by mentioning it.
...
By default, Carlito prioritizes normal chat behavior and keeps context mostly as received. This means allowlists primarily decide who can trigger actions, not a universal redaction boundary for every quoted or historical snippet.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@carlito", "carlito", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
