---
summary: "Messaging platforms Carlito can connect to"
read_when:
  - You want to choose a chat channel for Carlito
  - You need a quick overview of supported messaging platforms
title: "Chat channels"
---

Carlito can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and Carlito will route per chat.
