...
The plugin SDK is exposed as a set of narrow subpaths under `carlito/plugin-sdk/`.
...
| `plugin-sdk/config-schema`  | `CarlitoSchema`                                                                                                                        |
...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/config-schema` | Root `carlito.json` Zod schema export (`CarlitoSchema`) |
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/agent-harness` | Experimental trusted-plugin surface for low-level agent harnesses: harness types, active-run steer/abort helpers, Carlito tool bridge helpers, and attempt result utilities |
