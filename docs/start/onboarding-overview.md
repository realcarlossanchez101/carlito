---
summary: "Overview of Carlito onboarding options and flows"
read_when:
...
Carlito has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `carlito onboard`                      | Launch the app            |
...
CLI command docs: [`carlito onboard`](/cli/onboard)

## macOS app onboarding

Open the Carlito app. The first-run wizard walks you through the same steps
