---
summary: "First-run setup flow for Carlito (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Carlito">
...
<Step title="CLI">
  ...
  The app can install the global `carlito` CLI via npm, pnpm, or bun.
