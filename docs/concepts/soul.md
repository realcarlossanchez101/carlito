---
summary: "Use SOUL.md to give your Carlito agent an actual voice instead of generic assistant sludge"
read_when:
...
Carlito injects it on normal sessions, so it has real weight. If your agent
...
For Carlito, `SOUL.md` is that layer.
...
Path fixed for Carlito workspaces: use `SOUL.md`, not `http://SOUL.md`.
