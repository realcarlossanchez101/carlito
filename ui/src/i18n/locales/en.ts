...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from carlito dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with carlito models auth",
  ...
  cron: {
    ...
    form: {
      ...
      wakeMode: "Wake mode",
      now: "Now",
      nextPulsecheck: "Next pulsecheck",
      wakeModeHelp: "Now triggers immediately. Next pulsecheck waits for the next cycle.",
