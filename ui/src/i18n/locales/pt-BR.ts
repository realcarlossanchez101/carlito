...
export const pt_BR: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando carlito dashboard --no-open no desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentique novamente com carlito models auth",
  ...
  cron: {
    ...
    form: {
      ...
      now: "Agora",
      nextPulsecheck: "Próximo pulsecheck",
      wakeModeHelp: "Agora dispara imediatamente. Próximo pulsecheck aguarda o próximo ciclo.",
