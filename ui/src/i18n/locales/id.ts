...
export const id: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari carlito dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentikasi ulang dengan carlito models auth",
  ...
  cron: {
    ...
    form: {
      ...
      now: "Sekarang",
      nextPulsecheck: "Pulsecheck berikutnya",
      wakeModeHelp: "Now memicu segera. Next pulsecheck menunggu siklus berikutnya.",
