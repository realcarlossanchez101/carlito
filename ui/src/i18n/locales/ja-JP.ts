...
export const ja_JP: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "モバイルを使用していますか？ デスクトップで carlito dashboard --no-open から完全な URL（#token=... を含む）をコピーしてください。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — carlito models auth で再認証してください",
  ...
  cron: {
    ...
    form: {
      ...
      wakeMode: "ウェイクモード",
      now: "今すぐ",
      nextPulsecheck: "次の pulsecheck",
      wakeModeHelp: "Now は即時にトリガーされます。Next pulsecheck は次のサイクルまで待機します。",
