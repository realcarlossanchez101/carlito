...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z carlito dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą carlito models auth",
  ...
  cron: {
    ...
    form: {
      ...
      now: "Teraz",
      nextPulsecheck: "Następny pulsecheck",
      wakeModeHelp: "Teraz uruchamia od razu. Następny pulsecheck czeka na kolejny cykl.",
