...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Редагування carlito.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з carlito dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через carlito models auth",
  ...
  cron: {
    ...
    form: {
      ...
      now: "Зараз",
      nextPulsecheck: "Наступний pulsecheck",
      wakeModeHelp: "Зараз спрацьовує негайно. Наступний pulsecheck чекає наступного циклу.",
