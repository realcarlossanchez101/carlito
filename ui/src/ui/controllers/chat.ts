...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[carlito] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/realcarlossanchez101/carlito/issues/1909
