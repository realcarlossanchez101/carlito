    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="Carlito" />
          <div class="login-gate__title">Carlito</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="CARLITO_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>${t("overview.connection.step1")}${renderConnectCommand("carlito gateway run")}</li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("carlito dashboard")}</li>
