...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/carlito");
      expect(html).toContain('<a href="http://github.com/carlito"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Carlito中文](https://docs.carlito.ai)");
      expect(html).toContain('href="https://docs.carlito.ai"');
      expect(html).toContain("Carlito中文</a>");
    });
