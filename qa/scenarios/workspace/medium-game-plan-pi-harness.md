...
execution:
  kind: flow
  summary: Run with `pnpm carlito qa suite --provider-mode live-frontier --model openai/gpt-5.4 --alt-model openai/gpt-5.4 --fast --thinking medium --scenario medium-game-plan-pi-harness`.
  config:
