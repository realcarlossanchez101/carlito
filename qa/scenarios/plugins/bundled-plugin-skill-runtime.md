...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as CARLITO_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                CARLITO_HOME: homeDir,
                CARLITO_CONFIG_PATH: configPath,
                CARLITO_STATE_DIR: stateDir,
                CARLITO_OAUTH_DIR: path.join(stateDir, "credentials"),
                CARLITO_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
