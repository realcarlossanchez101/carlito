...
- Code: `.agents/skills/carlito-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/carlito-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
