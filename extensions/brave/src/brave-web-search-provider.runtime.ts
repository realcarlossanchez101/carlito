import type { SearchConfigRecord } from "carlito/plugin-sdk/provider-web-search";
import {
  buildSearchCacheKey,
...
function missingBraveKeyPayload() {
  return {
    ...
    message: `web_search (brave) needs a Brave Search API key. Run \`${formatCliCommand("carlito configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
