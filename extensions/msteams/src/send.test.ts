...
vi.mock("carlito/plugin-sdk/msteams", () => ({
...
vi.mock("carlito/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("carlito/plugin-sdk/text-runtime")>();
  return {
    ...actual,
