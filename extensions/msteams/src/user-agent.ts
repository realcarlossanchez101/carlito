...
function resolveCarlitoVersion(): string {
  try {
 ...
 * and appends the Carlito version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Carlito/<carlito-version>"
 * Example: "teams.ts[apps]/2.0.5 Carlito/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Carlito/${resolveCarlitoVersion()}`;
  return cachedUserAgent;
}
