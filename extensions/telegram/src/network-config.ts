...
import { isTruthyEnvValue, isWSL2Sync } from "carlito/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "carlito/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "CARLITO_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "CARLITO_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "CARLITO_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable CARLITO_TELEGRAM_DNS_RESULT_ORDER
