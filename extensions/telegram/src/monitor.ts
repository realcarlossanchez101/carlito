...
import { resolveAgentMaxConcurrent } from "carlito/plugin-sdk/config-runtime";
import type { CarlitoConfig } from "carlito/plugin-sdk/config-runtime";
import { loadConfig } from "carlito/plugin-sdk/config-runtime";
import { waitForAbortSignal } from "carlito/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: CarlitoConfig): RunOptions<unknown> {
  return {
    sink: {
