...
let clearRuntimeConfigSnapshot: typeof import("carlito/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("carlito/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
