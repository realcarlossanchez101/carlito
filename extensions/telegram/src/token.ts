import { resolveNormalizedAccountEntry } from "carlito/plugin-sdk/account-core";
import type { BaseTokenResolution } from "carlito/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "carlito/plugin-sdk/channel-core";
import type { CarlitoConfig } from "carlito/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "carlito/plugin-sdk/config-runtime";
import { resolveDefaultSecretProviderAlias } from "carlito/plugin-sdk/provider-auth";
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<CarlitoConfig, "secrets">;
  provider: string;
  id: string;
...
export function resolveTelegramToken(
  ...
  // See: https://github.com/realcarlossanchez101/carlito/issues/53876
