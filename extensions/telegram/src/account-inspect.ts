import { resolveAccountWithDefaultFallback } from "carlito/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "carlito/plugin-sdk/channel-core";
import type { CarlitoConfig } from "carlito/plugin-sdk/config-runtime";
import { coerceSecretRef } from "carlito/plugin-sdk/config-runtime";
...
function inspectTokenValue(params: { cfg: CarlitoConfig; value: unknown }): {
  token: string;
