...
function resolveGoogleChatAccountImpl(params: { cfg: CarlitoConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: CarlitoConfig) => {
...
function createGoogleChatCfg(): CarlitoConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
