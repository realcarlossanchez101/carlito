import { assertOkOrThrowHttpError, postJsonRequest } from "carlito/plugin-sdk/provider-http";
...
} from "carlito/plugin-sdk/speech-core";
import { asObject, trimToUndefined } from "carlito/plugin-sdk/speech-core";
...
function resolveGoogleTtsModelProviderApiKey(cfg?: CarlitoConfig): string | undefined {
