...
import { collectProviderDangerousNameMatchingScopes } from "carlito/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: CarlitoConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: CarlitoConfig,
  doctorFixCommand: string,
): { config: CarlitoConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: CarlitoConfig): string[] {
