...
vi.mock("carlito/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("carlito/plugin-sdk/routing")>(
    "carlito/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("carlito/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("carlito/plugin-sdk/agent-runtime")>(
    "carlito/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
