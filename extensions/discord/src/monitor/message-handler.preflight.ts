...
import { resolveControlCommandGate } from "carlito/plugin-sdk/command-auth-native";
...
import { isDangerousNameMatchingEnabled } from "carlito/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "carlito/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "carlito/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "carlito/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "carlito/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "carlito/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("carlito/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("carlito/plugin-sdk/conversation-binding-runtime");
