...
import * as pluginCommandsModule from "carlito/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "carlito/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: CarlitoConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: CarlitoConfig) => void;
