...
import { resolveTextChunksWithFallback } from "carlito/plugin-sdk/reply-payload";
import type { RetryRunner } from "carlito/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: CarlitoConfig },
): Promise<{ channelId: string; dm?: boolean }> {
