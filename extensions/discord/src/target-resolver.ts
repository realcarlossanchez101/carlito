import type { DirectoryConfigParams } from "carlito/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "carlito/plugin-sdk/messaging-targets";
