...
import { listCombinedAccountIds } from "carlito/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: CarlitoConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: CarlitoConfig): string {
