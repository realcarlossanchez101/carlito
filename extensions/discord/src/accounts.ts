...
import type { DiscordAccountConfig, DiscordActionConfig, CarlitoConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: CarlitoConfig): ResolvedDiscordAccount[] {
