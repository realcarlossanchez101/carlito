...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("carlito.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("carlito.discord.modalEntries");
