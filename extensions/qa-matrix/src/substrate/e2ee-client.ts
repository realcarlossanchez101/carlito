...
import type {
  ...
  MessageEventContent,
} from "@realcarlossanchez101/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@realcarlossanchez101/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } = await import("carlito/plugin-sdk/qa-runner-runtime");
