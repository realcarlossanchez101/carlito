...
import { hasConfiguredSecretInput } from "carlito/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: CarlitoConfig): Record<string, unknown> | null {
