...
} from "carlito/plugin-sdk/context-visibility-runtime";
import {
  loadSessionStore,
  resolveSessionStoreEntry,
} from "carlito/plugin-sdk/session-store-runtime";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("carlito/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("carlito/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<typeof import("carlito/plugin-sdk/acp-binding-runtime")> {
  acpBindingRuntimePromise ??= import("carlito/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("carlito/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("carlito/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_CARLITO_FINALIZED_PREVIEW_KEY]: true };
}
