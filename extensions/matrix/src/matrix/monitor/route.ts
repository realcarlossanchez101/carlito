import { resolveConfiguredAcpBindingRecord } from "carlito/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "carlito/plugin-sdk/session-binding-runtime";
