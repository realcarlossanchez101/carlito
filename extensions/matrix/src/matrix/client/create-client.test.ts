...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/carlito-matrix-create-client-test",
    storagePath: "/tmp/carlito-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/carlito-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/carlito-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/carlito-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "carlito-matrix-default-token-hash",
