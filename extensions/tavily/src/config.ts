...
export function resolveTavilySearchConfig(cfg?: CarlitoConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: CarlitoConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: CarlitoConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
