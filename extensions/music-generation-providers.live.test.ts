...
const providerFilter = parseCsvFilter(process.env.CARLITO_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.CARLITO_LIVE_MUSIC_GENERATION_MODELS);
