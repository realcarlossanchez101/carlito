...
vi.mock("carlito/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("carlito/plugin-sdk/channel-pairing", () => ({
...
vi.mock("carlito/plugin-sdk/command-auth", () => ({
...
vi.mock("carlito/plugin-sdk/group-access", () => ({
...
vi.mock("carlito/plugin-sdk/routing", () => ({
