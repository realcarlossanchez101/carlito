...
import { __testing as sessionBindingTesting } from "carlito/plugin-sdk/conversation-runtime";
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "carlito-line-context-"));
  ...
  it("group peer binding matches raw groupId without prefix (#21907)", async () => {
    ...
    const bindingCfg: CarlitoConfig = {
