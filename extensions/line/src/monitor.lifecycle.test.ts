...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "carlito/plugin-sdk/webhook-request-guards";
...
vi.mock("carlito/plugin-sdk/reply-runtime", () => ({
...
vi.mock("carlito/plugin-sdk/webhook-ingress", () => ({
