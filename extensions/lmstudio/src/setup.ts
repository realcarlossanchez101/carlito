...
import { withAgentModelAliases } from "carlito/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: CarlitoConfig): CarlitoConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<CarlitoConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
