...
vi.mock("carlito/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("carlito/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
