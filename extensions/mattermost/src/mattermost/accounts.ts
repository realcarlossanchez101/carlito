import { createAccountListHelpers } from "carlito/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "carlito/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "carlito/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: CarlitoConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: CarlitoConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CarlitoConfig): ResolvedMattermostAccount[] {
