...
import { resolveDangerousNameMatchingEnabled } from "carlito/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Carlito config object. */
function getChannelConfig(cfg: CarlitoConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: CarlitoConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.CARLITO_BOT_NAME ?? "Carlito";
