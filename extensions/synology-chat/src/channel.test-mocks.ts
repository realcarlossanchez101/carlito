...
vi.mock("carlito/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("carlito/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("carlito/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("carlito/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("carlito/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("carlito/plugin-sdk/webhook-ingress");
  return {
    ...actual,
