...
import { collectIssuesForEnabledAccounts } from "carlito/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: carlito channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
