...
This package contains the **BlueBubbles external channel plugin** for Carlito.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `carlito/plugin-sdk` helpers.
