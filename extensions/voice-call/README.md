...
Official Voice Call plugin for **Carlito**.
...
Docs: `https://docs.carlito.ai/plugins/voice-call`
Plugin system: `https://docs.carlito.ai/plugin`

## Install (local dev)

### Option A: install via Carlito (recommended)
...
```bash
PLUGIN_HOME=~/.carlito/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.carlito.ai/plugins/voice-call`
...
`https://docs.carlito.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.carlito.ai/plugins/voice-call#tts-for-calls`
