...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "carlito/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("carlito.feishuThreadBindingsState");
