# @realcarlossanchez101/diffs

Read-only diff viewer plugin for **Carlito** agents.
...
Before:
Carlito supports plugins.

After:
Carlito supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/carlito-diffs`).
