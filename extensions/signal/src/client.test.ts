...
vi.mock("carlito/plugin-sdk/fetch-runtime", () => ({
  resolveFetch: (...args: unknown[]) => resolveFetchMock(...args),
}));

vi.mock("carlito/plugin-sdk/core", async () => {
  const actual =
    await vi.importActual<typeof import("carlito/plugin-sdk/core")>("carlito/plugin-sdk/core");
  return {
    ...actual,
