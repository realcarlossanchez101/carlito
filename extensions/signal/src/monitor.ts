...
import type { SignalReactionNotificationMode } from "carlito/plugin-sdk/config-runtime";
...
import { estimateBase64DecodedBytes, saveMediaBuffer } from "carlito/plugin-sdk/media-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "carlito/plugin-sdk/reply-history";
import {
