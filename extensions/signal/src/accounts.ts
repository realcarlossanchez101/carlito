...
function mergeSignalAccountConfig(cfg: CarlitoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: CarlitoConfig): ResolvedSignalAccount[] {
