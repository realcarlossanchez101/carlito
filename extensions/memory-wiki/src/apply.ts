...
const GENERATED_START = "<!-- carlito:wiki:generated:start -->";
const GENERATED_END = "<!-- carlito:wiki:generated:end -->";
const HUMAN_START = "<!-- carlito:human:start -->";
const HUMAN_END = "<!-- carlito:human:end -->";
