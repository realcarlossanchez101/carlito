...
function mergeZalouserAccountConfig(cfg: CarlitoConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: CarlitoConfig; accountId?: string | null }) {
