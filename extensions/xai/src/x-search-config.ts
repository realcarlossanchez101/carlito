...
export function resolveLegacyXSearchConfig(config?: CarlitoConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: CarlitoConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: CarlitoConfig): JsonRecord | undefined {
