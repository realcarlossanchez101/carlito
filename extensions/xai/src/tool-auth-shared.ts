...
function readLegacyGrokFallbackAuth(cfg?: CarlitoConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: CarlitoConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function readLegacyGrokApiKey(cfg?: CarlitoConfig): string | undefined {
...
export function readPluginXaiWebSearchApiKey(cfg?: CarlitoConfig): string | undefined {
  const resolved = readPluginXaiWebSearchApiKeyResult(cfg);
  return resolved.status === "available" ? resolved.value : undefined;
}

export function resolveFallbackXaiAuth(cfg?: CarlitoConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: CarlitoConfig): string | undefined {
