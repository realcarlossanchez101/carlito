...
import type { CarlitoPluginApi } from "carlito/plugin-sdk/memory-core";
import {
  buildSessionEntry,
...
import type { MemorySearchResult } from "carlito/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__carlito_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__carlito_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- carlito:dreaming:light:start -->",
    endMarker: "<!-- carlito:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- carlito:dreaming:rem:start -->",
    endMarker: "<!-- carlito:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: CarlitoPluginApi): void {
