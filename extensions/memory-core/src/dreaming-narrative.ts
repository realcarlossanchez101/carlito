...
import { resolveGlobalMap } from "carlito/plugin-sdk/global-singleton";
import { createAsyncLock } from "carlito/plugin-sdk/infra-runtime";
import { resolveStateDir } from "carlito/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- carlito:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- carlito:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "carlito:dreaming:backfill-entry";
