/**
 * Twitch channel plugin for Carlito.
 *
...
import { buildChannelConfigSchema } from "carlito/plugin-sdk/channel-config-schema";
import { createChatChannelPlugin } from "carlito/plugin-sdk/channel-core";
import {
  createLoggedPairingApprovalNotifier,
  createPairingPrefixStripper,
} from "carlito/plugin-sdk/channel-pairing";
 ...
 * for Carlito. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: CarlitoConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: CarlitoConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: CarlitoConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: CarlitoConfig): boolean =>
