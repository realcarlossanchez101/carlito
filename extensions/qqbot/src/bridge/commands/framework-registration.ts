...
import type { CarlitoPluginApi, PluginCommandContext } from "carlito/plugin-sdk/plugin-entry";
...
export function registerQQBotFrameworkCommands(api: CarlitoPluginApi): void {
