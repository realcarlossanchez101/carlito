...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "carlito/plugin-sdk/config-runtime";
import { resolveOAuthDir } from "carlito/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: CarlitoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CarlitoConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CarlitoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CarlitoConfig): ResolvedWhatsAppAccount[] {
