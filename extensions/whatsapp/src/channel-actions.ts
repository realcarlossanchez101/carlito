...
function areWhatsAppAgentReactionsEnabled(params: { cfg: CarlitoConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: CarlitoConfig) {
