import type { CarlitoConfig as RuntimeApiCarlitoConfig } from "carlito/plugin-sdk/config-runtime";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiCarlitoConfig["channels"]>["imessage"]>,
