...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: CarlitoConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: CarlitoConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: CarlitoConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Carlito has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: CarlitoConfig; accountId?: string }) =>
