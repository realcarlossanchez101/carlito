...
import { readSessionUpdatedAt, resolveStorePath } from "carlito/plugin-sdk/config-runtime";
import {
  readChannelAllowFromStore,
  upsertChannelPairingRequest,
} from "carlito/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "carlito/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "carlito/plugin-sdk/host-runtime";
import { waitForTransportReady } from "carlito/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "carlito/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "carlito/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "carlito/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "carlito/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "carlito/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "carlito/plugin-sdk/runtime-env";
 ...
 *   exec ssh -T carlito@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., carlito@192.168.64.3)
