# @realcarlossanchez101/nostr

Nostr DM channel plugin for Carlito using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Carlito. It enables your bot to:
...
# Configure carlito to use local relay
