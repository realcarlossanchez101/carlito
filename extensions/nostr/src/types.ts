...
import { normalizeSecretInputString, type SecretInput } from "carlito/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: CarlitoConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: CarlitoConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: CarlitoConfig): string {
