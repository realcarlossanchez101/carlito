...
function enableSlackAccount(cfg: CarlitoConfig, accountId: string): CarlitoConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: CarlitoConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: CarlitoConfig; accountId: string }) =>
