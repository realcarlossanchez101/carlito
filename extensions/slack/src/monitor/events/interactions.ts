...
// Prefix for Carlito-generated action IDs to scope our handler
const CARLITO_ACTION_PREFIX = "carlito:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${CARLITO_ACTION_PREFIX}`);

  // Handle Carlito modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
