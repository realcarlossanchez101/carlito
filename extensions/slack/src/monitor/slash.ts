...
import type { ChatCommandDefinition } from "carlito/plugin-sdk/command-auth";
import {
  type CommandArgs,
...
import { chunkItems, normalizeLowercaseStringOrEmpty } from "carlito/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "carlito_cmdarg";
const SLACK_COMMAND_ARG_ACTION_LISTENER = /^carlito_cmdarg/;
