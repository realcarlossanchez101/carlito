import { formatInboundEnvelope } from "carlito/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "carlito/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("carlito/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
