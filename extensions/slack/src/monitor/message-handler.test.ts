...
vi.mock("carlito/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("carlito/plugin-sdk/channel-inbound")>(
    "carlito/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
