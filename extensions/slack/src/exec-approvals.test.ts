...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CarlitoConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CarlitoConfig["channels"]>["slack"]>>,
): CarlitoConfig {
  return {
    channels: {
      slack: {
