---
name: carlito-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Carlito GitHub Secret Scanning alerts in issues or PRs.
---

# Carlito Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/realcarlossanchez101/carlito/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/carlito-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/realcarlossanchez101/carlito/issues/63101#issuecomment-xxx",
