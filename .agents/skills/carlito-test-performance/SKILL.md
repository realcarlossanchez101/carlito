---
name: carlito-test-performance
description: Benchmark, diagnose, and optimize Carlito test runtime, import hotspots, CPU/RSS, and slow coverage paths.
---

# Carlito Test Performance
...
2. Establish a baseline before changing code:
   ...
   - For import-heavy suspicion add:
     `CARLITO_VITEST_IMPORT_DURATIONS=1 CARLITO_VITEST_PRINT_IMPORT_BREAKDOWN=1`.
...
timeout 240 /usr/bin/time -l env \
  CARLITO_VITEST_IMPORT_DURATIONS=1 \
  CARLITO_VITEST_PRINT_IMPORT_BREAKDOWN=1 \
