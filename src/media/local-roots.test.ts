...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "carlito-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "carlito-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "carlito-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "carlito-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "carlito-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "carlito-legacy-state");
    const configDir = path.join("/tmp", "carlito-current-config");
