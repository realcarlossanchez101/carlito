...
export const A2UI_PATH = "/__carlito__/a2ui";

export const CANVAS_HOST_PATH = "/__carlito__/canvas";

export const CANVAS_WS_PATH = "/__carlito__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.carlitoCanvasA2UIAction.postMessage(...)
  // - Android: window.carlitoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["carlitoCanvasA2UIAction"];
  ...
  globalThis.Carlito = globalThis.Carlito ?? {};
  globalThis.Carlito.postMessage = postToNode;
  globalThis.Carlito.sendUserAction = sendUserAction;
  globalThis.carlitoPostMessage = postToNode;
  globalThis.carlitoSendUserAction = sendUserAction;
