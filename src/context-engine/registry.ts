...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("carlito.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("carlito.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: CarlitoConfig): Promise<ContextEngine> {
