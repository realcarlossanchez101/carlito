...
export function scanLegacyToolsBySenderKeys(cfg: CarlitoConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: CarlitoConfig): {
