...
export function collectMissingDefaultAccountBindingWarnings(cfg: CarlitoConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: CarlitoConfig): string[] {
  const warnings: string[] = [];
