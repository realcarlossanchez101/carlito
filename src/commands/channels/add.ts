...
import { replaceConfigFile, type CarlitoConfig } from "../../config/config.js";
...
async function resolveCatalogChannelEntry(raw: string, cfg: CarlitoConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as CarlitoConfig;
  ...
  // May trigger loadCarlitoPlugins on cache miss (disk scan + jiti import)
