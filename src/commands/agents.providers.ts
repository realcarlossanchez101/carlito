...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CarlitoConfig): boolean {
...
export function summarizeBindings(cfg: CarlitoConfig, bindings: AgentBinding[]): string[] {
