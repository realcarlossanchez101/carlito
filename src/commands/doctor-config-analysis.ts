...
import { CarlitoSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: CarlitoConfig): {
  config: CarlitoConfig;
  removed: string[];
} {
  const parsed = CarlitoSchema.safeParse(config);
  if (parsed.success) {
...
export function noteOpencodeProviderOverrides(cfg: CarlitoConfig): void {
