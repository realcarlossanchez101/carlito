...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set CARLITO_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `carlito dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Carlito.");
  } else if (hint) {
    runtime.log(hint);
  }
}
