...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: CarlitoConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: CarlitoConfig, deps?: BrowserDoctorDeps) {
  try {
