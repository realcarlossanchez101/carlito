...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.CARLITO_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.CARLITO_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.CARLITO_SERVICE_MARKER = originalServiceMarker;
    }
  });
