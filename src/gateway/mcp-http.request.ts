...
function resolveScopedSessionKey(cfg: CarlitoConfig, rawSessionKey: string | undefined): string {
...
export function resolveMcpRequestContext(
  ...
  return {
    ...
    messageProvider:
      normalizeMessageChannel(getHeader(req, "x-carlito-message-channel")) ?? undefined,
    accountId: normalizeOptionalString(getHeader(req, "x-carlito-account-id")),
