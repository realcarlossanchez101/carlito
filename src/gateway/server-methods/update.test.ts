...
vi.mock("../../infra/carlito-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/carlito-root.js")>(
    "../../infra/carlito-root.js",
  );
  return {
    ...actual,
    resolveCarlitoPackageRoot: async () => "/tmp/carlito",
  };
});
