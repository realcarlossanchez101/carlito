...
import type { ConfigValidationIssue, CarlitoConfig } from "../../config/types.carlito.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: CarlitoConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: CarlitoConfig, next: CarlitoConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadCarlitoPlugins() (called inside
