...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CarlitoConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CarlitoConfig): void {
