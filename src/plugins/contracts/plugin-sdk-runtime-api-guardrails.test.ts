...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type CarlitoConfig } from "carlito/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "carlito/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "carlito/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiCarlitoConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "carlito/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "carlito/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "carlito/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "carlito/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "carlito/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "carlito/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "carlito/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "carlito/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "carlito/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "carlito/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "carlito/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "carlito/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, CarlitoConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "carlito/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "carlito/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile({
    ...
    'export * from "carlito/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      'export type { CarlitoPluginApi } from "carlito/plugin-sdk/plugin-entry";',
      'export type { ChannelMessageActionAdapter } from "carlito/plugin-sdk/channel-contract";',
      'export type { TelegramApiOverride } from "./src/send.js";',
      'export type { CarlitoPluginService, CarlitoPluginServiceContext, PluginLogger } from "carlito/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "carlito/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "carlito/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "carlito/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "carlito/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "carlito/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "carlito/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "carlito/plugin-sdk/channel-actions";',
      ...
      'export type { CarlitoConfig } from "carlito/plugin-sdk/config-runtime";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeCarlitoConfig["channels"]>["telegram"] >;',
