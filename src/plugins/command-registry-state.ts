...
import type { CarlitoPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = CarlitoPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("carlito.pluginCommandsState");
