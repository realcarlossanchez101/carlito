...
export function applyProviderDefaultModel(cfg: CarlitoConfig, modelRef: string): CarlitoConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: CarlitoConfig; modelId: string; modelRef: string; profileId: string } {
