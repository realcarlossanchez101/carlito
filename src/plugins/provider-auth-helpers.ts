...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveCarlitoAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: CarlitoConfig): SecretRef {
