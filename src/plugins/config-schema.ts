...
import type { CarlitoPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: CarlitoPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): CarlitoPluginConfigSchema {
  return {
