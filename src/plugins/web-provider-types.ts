...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: CarlitoConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: CarlitoConfig, value: unknown) => void;
  applySelectionConfig?: (config: CarlitoConfig) => CarlitoConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => CarlitoConfig | Promise<CarlitoConfig>;
