...
function makeTempDir() {
  return makeTrackedTempDir("carlito-plugin-loader", tempRoots);
}
...
describe("plugin loader git path regression", () => {
  it("loads git-style package extension entries when they import plugin-sdk infra-runtime (#49806)", async () => {
    ...
    fs.writeFileSync(
      ...
      `import { resolveOutboundSendDep } from "carlito/plugin-sdk/infra-runtime";
...
`,
    ...
    const script = `
      ...
      const withAlias = createJiti(${JSON.stringify(jitiBaseFile)}, {
        ...
        extensions: [".ts", ".tsx", ".mts", ".cts", ".mtsx", ".ctsx", ".js", ".mjs", ".cjs", ".json"],
        alias: {
          "carlito/plugin-sdk/infra-runtime": ${JSON.stringify(copiedChannelRuntimeShim)},
        },
      });
