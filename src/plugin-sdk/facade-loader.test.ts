...
const FACADE_LOADER_GLOBAL = "__carlitoTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("carlito-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("carlito-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("carlito-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("carlito-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("carlito-facade-loader-circular-");
    process.env.CARLITO_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("carlito-facade-loader-throw-");
    process.env.CARLITO_BUNDLED_PLUGINS_DIR = dir;
