...
import type { ModelDefinitionConfig, CarlitoConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: CarlitoConfig) => CarlitoConfig;
  applyLitellmProviderConfig: (cfg: CarlitoConfig) => CarlitoConfig;
