...
export type { CarlitoConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: CarlitoConfig, ...args: TArgs) => CarlitoConfig;
  applyConfig: (cfg: CarlitoConfig, ...args: TArgs) => CarlitoConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: CarlitoConfig, preset: TParams) => CarlitoConfig;
  primaryModelRef: string;
...
export function applyAgentDefaultModelPrimary(cfg: CarlitoConfig, primary: string): CarlitoConfig {
...
export function applyOpencodeZenModelDefault(cfg: CarlitoConfig): {
  next: CarlitoConfig;
  changed: boolean;
} {
