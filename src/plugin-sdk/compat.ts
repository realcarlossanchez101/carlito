...
const shouldWarnCompatImport =
  ...
  process.env.CARLITO_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "carlito/plugin-sdk/compat is deprecated for new plugins. Migrate to focused carlito/plugin-sdk/<subpath> imports. See https://docs.carlito.ai/plugins/sdk-migration",
    {
      code: "CARLITO_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.carlito.ai/plugins/sdk-migration",
    },
  );
}
