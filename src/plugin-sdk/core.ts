...
import type { CarlitoPluginApi } from "../plugins/types.js";
...
export type { CarlitoPluginToolContext, CarlitoPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: CarlitoConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
