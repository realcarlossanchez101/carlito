...
import type { ModelProviderConfig, CarlitoConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: CarlitoConfig) => CarlitoConfig;
  applyOpenrouterProviderConfig: (cfg: CarlitoConfig) => CarlitoConfig;
