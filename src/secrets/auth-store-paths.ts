...
export function listAuthProfileStorePaths(config: CarlitoConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: CarlitoConfig, stateDir: string): string[] {
