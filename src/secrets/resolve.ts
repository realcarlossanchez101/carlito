...
function resolveResolutionLimits(config: CarlitoConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CarlitoConfig): SecretProviderConfig {
