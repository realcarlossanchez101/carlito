...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "carlito.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Carlito out-of-band. Treat it as authoritative metadata about the current message context.",
