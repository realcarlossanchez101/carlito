...
const emptyCfg = {} as CarlitoConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as CarlitoConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as CarlitoConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
