...
function resolveAcpStreamCoalesceIdleMs(cfg: CarlitoConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CarlitoConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CarlitoConfig): AcpProjectionSettings {
