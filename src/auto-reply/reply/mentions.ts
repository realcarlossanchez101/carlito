...
function resolveMentionPatterns(cfg: CarlitoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: CarlitoConfig | undefined, agentId?: string): RegExp[] {
