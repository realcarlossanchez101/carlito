...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@carlito", { botUsername: "carlito" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@carlito args", {
        botUsername: "carlito",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "carlito" })).toBe(
      "/help@otherbot",
    );
  });
