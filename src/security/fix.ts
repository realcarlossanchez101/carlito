...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CarlitoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CarlitoConfig; env: NodeJS.ProcessEnv }): {
  cfg: CarlitoConfig;
  changes: string[];
} {
