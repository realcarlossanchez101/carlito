/**
 * Hook system for Carlito agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("carlito.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("carlito.internalHooksEnabled");
