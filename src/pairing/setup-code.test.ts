...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("CARLITO_GATEWAY_TOKEN", "");
    vi.stubEnv("CARLITO_GATEWAY_PASSWORD", "");
    vi.stubEnv("CARLITO_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses CARLITO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          CARLITO_GATEWAY_TOKEN: "new-token",
        },
