...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: CarlitoConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: CarlitoConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: CarlitoConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: CarlitoConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: CarlitoConfig }): Promise<void> {
