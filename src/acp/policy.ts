...
export function isAcpEnabledByPolicy(cfg: CarlitoConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: CarlitoConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: CarlitoConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: CarlitoConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: CarlitoConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: CarlitoConfig, agentId: string): boolean {
