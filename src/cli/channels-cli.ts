    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["carlito channels list", "List configured channels and auth profiles."],
          ["carlito channels status --probe", "Run channel status checks and probes."],
          [
            "carlito channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["carlito channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.carlito.ai/cli/channels",
        )}\n`,
    );
