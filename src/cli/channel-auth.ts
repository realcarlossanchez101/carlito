...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: CarlitoConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: CarlitoConfig, mode: ChannelAuthMode): string {
