    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["carlito directory self --channel slack", "Show the connected account identity."],
          [
            'carlito directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["carlito directory groups list --channel discord", "List available groups/channels."],
          [
            "carlito directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.carlito.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
