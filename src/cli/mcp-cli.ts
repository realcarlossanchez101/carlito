...
import { serveCarlitoChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Carlito MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Carlito channels over MCP stdio")
