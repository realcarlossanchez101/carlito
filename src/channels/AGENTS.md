...
- Keep extension-facing channel surfaces flowing through `carlito/plugin-sdk/*`
...
- For bundled plugin channel changes that can affect startup/import cost, run:
  `CARLITO_LOCAL_CHECK=0 node scripts/profile-extension-memory.mjs --extension <id> --skip-combined --concurrency 1`
