...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: CarlitoConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: CarlitoConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: CarlitoConfig) => string;
  ...
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: CarlitoConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: CarlitoConfig) => string>;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: CarlitoConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: CarlitoConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: CarlitoConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: CarlitoConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: CarlitoConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: CarlitoConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.carlito.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: CarlitoConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: CarlitoConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: CarlitoConfig;
    nextCfg: CarlitoConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: CarlitoConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: CarlitoConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: CarlitoConfig; accountId?: string | null }) =>
    | {
