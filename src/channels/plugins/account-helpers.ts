...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: CarlitoConfig): string | undefined {
  ...
  function listAccountIds(cfg: CarlitoConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: CarlitoConfig): string {
