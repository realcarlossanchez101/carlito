...
export type CarlitoConfig = {
  $schema?: string;
  meta?: {
    /** Last Carlito version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Carlito UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const carlitoConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = CarlitoConfig & {
  readonly [carlitoConfigStateBrand]?: TState;
};
