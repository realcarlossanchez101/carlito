...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.pulsecheck.includeSystemPromptSection":
    "Pulsecheck Include System Prompt Section",
  "agents.list.*.pulsecheck.includeSystemPromptSection": "Pulsecheck Include System Prompt Section",
  "agents.list[].embeddedPi": "Agent Embedded Pi",
  "agents.list[].embeddedPi.executionContract": "Agent Embedded Pi Execution Contract",
  "agents.defaults.pulsecheck.directPolicy": "Pulsecheck Direct Policy",
  "agents.list.*.pulsecheck.directPolicy": "Pulsecheck Direct Policy",
  "agents.defaults.pulsecheck.suppressToolErrorWarnings": "Pulsecheck Suppress Tool Error Warnings",
  "agents.list.*.pulsecheck.suppressToolErrorWarnings": "Pulsecheck Suppress Tool Error Warnings",
  "agents.defaults.pulsecheck.timeoutSeconds": "Pulsecheck Timeout (Seconds)",
  "agents.list.*.pulsecheck.timeoutSeconds": "Pulsecheck Timeout (Seconds)",
  ...
  "web.pulsecheckSeconds": "Web Channel Pulsecheck Interval (sec)",
  ...
  "channels.defaults.pulsecheck": "Default Pulsecheck Visibility",
  "channels.defaults.pulsecheck.showOk": "Pulsecheck Show OK",
  "channels.defaults.pulsecheck.showAlerts": "Pulsecheck Show Alerts",
  "channels.defaults.pulsecheck.useIndicator": "Pulsecheck Use Indicator",
  ...
  "agents.list[].pulsecheck.suppressToolErrorWarnings":
    "Agent Pulsecheck Suppress Tool Error Warnings",
  "agents.list[].pulsecheck.timeoutSeconds": "Agent Pulsecheck Timeout (Seconds)",
