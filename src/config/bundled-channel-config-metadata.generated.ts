...
export const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = [
  ...
  },
  {
    ...
    label: "QA Channel",
    description: "Synthetic Slack-class transport for automated Carlito QA scenarios.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
  ...
  },
  {
    ...
    label: "Synology Chat",
    description: "Connect your Synology NAS Chat to Carlito with full agent capabilities.",
    schema: {
      $schema: "http://json-schema.org/draft-07/schema#",
      type: "object",
      properties: {
