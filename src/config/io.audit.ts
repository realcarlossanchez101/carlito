...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.CARLITO_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.CARLITO_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.CARLITO_WATCH_COMMAND),
