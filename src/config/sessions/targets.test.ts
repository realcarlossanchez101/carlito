...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): CarlitoConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: CarlitoConfig, env: NodeJS.ProcessEnv) =>
