...
function resolveRealtimeVoiceProviderEntries(cfg?: CarlitoConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: CarlitoConfig): RealtimeVoiceProviderPlugin[] {
