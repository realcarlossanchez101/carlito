...
function resolveSpeechProviderPluginEntries(cfg?: CarlitoConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: CarlitoConfig): SpeechProviderPlugin[] {
