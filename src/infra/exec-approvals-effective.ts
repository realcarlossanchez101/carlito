...
const DEFAULT_HOST_PATH = "~/.carlito/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `Carlito default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `Carlito default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
