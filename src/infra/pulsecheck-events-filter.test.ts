...
describe("pulsecheck event prompts", () => {
  it.each([
    {
      ...
      unexpected: ["Handle this reminder internally", "Reply PULSECHECK_OK."],
    },
    {
    ...
    {
      name: "falls back to bare pulsecheck reply when cron content is empty",
      events: ["", "   "],
      expected: ["Reply PULSECHECK_OK."],
    ...
    },
    {
      ...
      expected: [
        ...
        "PULSECHECK_OK when nothing needs user-facing follow-up",
      ],
      unexpected: ["Please relay this reminder to the user"],
    },
...
describe("pulsecheck event classification", () => {
  it.each([
  ...
  it.each([
    ...
    { value: "   ", expected: false },
    { value: "PULSECHECK_OK", expected: false },
    { value: "pulsecheck_ok: already handled", expected: false },
    { value: "pulsecheck poll: noop", expected: false },
    { value: "pulsecheck wake: noop", expected: false },
