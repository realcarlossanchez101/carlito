...
function resolveSlackPluginOriginTarget(params: { cfg: CarlitoConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "carlito-exec-approval-session-target-" }, (tmpDir) => {
