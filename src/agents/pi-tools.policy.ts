...
export function resolveSubagentToolPolicy(cfg?: CarlitoConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: CarlitoConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: CarlitoConfig["tools"];
