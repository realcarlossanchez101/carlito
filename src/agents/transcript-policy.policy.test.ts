...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.CARLITO_BUNDLED_PLUGINS_DIR;
  delete env.CARLITO_SKIP_PROVIDERS;
  delete env.CARLITO_SKIP_CHANNELS;
  delete env.CARLITO_SKIP_CRON;
  delete env.CARLITO_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
