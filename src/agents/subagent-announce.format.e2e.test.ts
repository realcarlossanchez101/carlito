...
let configOverride: CarlitoConfig = {
  session: {
    mainKey: "main",
    scope: "per-sender",
  },
...
function setConfigOverride(next: CarlitoConfig): void {
  configOverride = next;
...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/realcarlossanchez101/carlito/issues/31298
    previousFastTestEnv = process.env.CARLITO_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.CARLITO_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // CARLITO_TEST_FAST is set in beforeAll before module import
