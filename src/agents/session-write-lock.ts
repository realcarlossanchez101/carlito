...
const CLEANUP_STATE_KEY = Symbol.for("carlito.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("carlito.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("carlito.sessionWriteLockWatchdogState");
...
function shouldStartBackgroundWatchdog(): boolean {
  return process.env.VITEST !== "true" || process.env.CARLITO_TEST_SESSION_LOCK_WATCHDOG === "1";
}
