...
export const createCarlitoCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createCarlitoCodingToolsMock.mockReset();
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveCarlitoDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveCarlitoAgentDir: vi.fn(() => "/tmp"),
  }));
