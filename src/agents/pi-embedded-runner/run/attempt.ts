...
import { createCarlitoCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    try {
      ...
      // exact Carlito-managed registrations so custom tools survive startup and
      ...
      try {
        ...
        // double-compaction. See: https://github.com/realcarlossanchez101/carlito/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("carlito:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/realcarlossanchez101/carlito/issues/8643
