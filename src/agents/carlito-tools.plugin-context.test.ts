...
import { resolveCarlitoPluginToolInputs } from "./carlito-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("carlito plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveCarlitoPluginToolInputs({
      options: {
        config: {} as never,
