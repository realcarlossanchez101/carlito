...
function resolveWatchPaths(workspaceDir: string, config?: CarlitoConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CarlitoConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CarlitoConfig }) {
