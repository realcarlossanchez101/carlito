...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: CarlitoConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: CarlitoConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: CarlitoConfig, runTimeoutSeconds?: number) {
