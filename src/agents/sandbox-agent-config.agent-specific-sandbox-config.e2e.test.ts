...
async function resolveContext(config: CarlitoConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CarlitoConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
