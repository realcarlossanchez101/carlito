...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "carlito-openai-responses-transport",
  "openai-codex-responses": "carlito-openai-responses-transport",
  "openai-completions": "carlito-openai-completions-transport",
  "azure-openai-responses": "carlito-azure-openai-responses-transport",
  "anthropic-messages": "carlito-anthropic-messages-transport",
  "google-generative-ai": "carlito-google-generative-ai-transport",
};
