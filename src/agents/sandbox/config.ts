...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/carlito-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: CarlitoConfig, agentId?: string): SandboxConfig {
