...
export const DEFAULT_SANDBOX_IMAGE = "carlito-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "carlito-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "carlito-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "carlito-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "carlito-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "carlito-sandbox-browser";
