...
export function resolveSessionToolsVisibility(cfg: CarlitoConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: CarlitoConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: CarlitoConfig): AgentToAgentPolicy {
