...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<CarlitoConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<CarlitoConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: CarlitoConfig): WebSearchConfig {
