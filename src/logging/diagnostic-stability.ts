...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __carlitoDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__carlitoDiagnosticStabilityState ??= createState();
  return globalStore.__carlitoDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__carlitoDiagnosticStabilityState = next;
}
