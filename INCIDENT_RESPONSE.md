# Carlito Incident Response Plan
...
- **High:** Verified trust-boundary bypass requiring limited preconditions (for example authenticated but unauthorized high-impact action), or exposure of Carlito-owned sensitive credentials.
