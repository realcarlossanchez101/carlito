...
export const OPTIONAL_BUNDLED_BUILD_ENV = "CARLITO_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.carlito?.install?.npmSpec === "string" &&
    packageJson.carlito.install.npmSpec.trim().length > 0
  );
}
