...
show_usage() {
    cat << EOF
clawlog - Carlito Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Carlito logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Carlito logs flow through the macOS unified log (subsystem: ai.carlito).
