...
if [[ -z "$version_content" ]]; then
  echo "<h2>Carlito $VERSION</h2>"
  echo "<p>Latest Carlito update.</p>"
  echo "<p><a href=\"https://github.com/realcarlossanchez101/carlito/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
