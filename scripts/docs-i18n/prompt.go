...
- Keep product names in English: Carlito, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Carlito Gateway, use “Gateway 网关”.
