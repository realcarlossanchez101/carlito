...
- CARLITO_IOS_VERSION = exact canonical iOS version
- CARLITO_MARKETING_VERSION = short iOS/App Store version
- CARLITO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
CARLITO_IOS_VERSION = ${IOS_VERSION}
CARLITO_MARKETING_VERSION = ${MARKETING_VERSION}
CARLITO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
