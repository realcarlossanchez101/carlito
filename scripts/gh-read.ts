...
const APP_ID_ENV = "CARLITO_GH_READ_APP_ID";
const KEY_FILE_ENV = "CARLITO_GH_READ_PRIVATE_KEY_FILE";
const INSTALLATION_ID_ENV = "CARLITO_GH_READ_INSTALLATION_ID";
const PERMISSIONS_ENV = "CARLITO_GH_READ_PERMISSIONS";
...
async function main() {
  if (process.argv.length <= 2) {
    fail(
      "usage: scripts/gh-read <gh args...>\nset CARLITO_GH_READ_APP_ID and CARLITO_GH_READ_PRIVATE_KEY_FILE first",
    );
  }
