...
# Output:
# - dist/Carlito.app
# - dist/Carlito-<version>.zip
# - dist/Carlito-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.carlito.mac}"
...
ZIP="$ROOT_DIR/dist/Carlito-$VERSION.zip"
DMG="$ROOT_DIR/dist/Carlito-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Carlito-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Carlito-$VERSION.dSYM.zip"
