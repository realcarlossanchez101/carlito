...
IMAGE_NAME="$(docker_e2e_resolve_image "carlito-gateway-network-e2e" CARLITO_GATEWAY_NETWORK_E2E_IMAGE)"
SKIP_BUILD="${CARLITO_GATEWAY_NETWORK_E2E_SKIP_BUILD:-0}"

PORT="18789"
TOKEN="e2e-$(date +%s)-$$"
NET_NAME="carlito-net-e2e-$$"
GW_NAME="carlito-gateway-e2e-$$"
