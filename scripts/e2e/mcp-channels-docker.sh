...
IMAGE_NAME="$(docker_e2e_resolve_image "carlito-mcp-channels-e2e" CARLITO_IMAGE)"
PORT="18789"
TOKEN="mcp-e2e-$(date +%s)-$$"
CONTAINER_NAME="carlito-mcp-e2e-$$"
CLIENT_LOG="$(mktemp -t carlito-mcp-client-log.XXXXXX)"
