...
const targetModel =
  modelIds.find((id) => id === "carlito/default") ?? modelIds.find((id) => id === "carlito");
if (!targetModel) {
  throw new Error(`carlito model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
