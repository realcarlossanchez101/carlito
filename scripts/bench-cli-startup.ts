...
const DEFAULT_ENTRY = "carlito.mjs";
...
function printUsage(): void {
  console.log(`Carlito CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: carlito.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "carlito-cli-bench-"));
