...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']carlito\/plugin-sdk["']/,
    hint: "Use carlito/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']carlito\/plugin-sdk\/test-utils["']/,
    hint: "Use carlito/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']carlito\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or carlito/plugin-sdk/testing for public surfaces.",
  },
  {
  ...
  },
  {
    ...
    hint: "Use carlito/plugin-sdk/testing for channel contract test helpers.",
  },
];
